/*
 ...
 GIVEAWAYADDR = 'AawayCoUtJSdQeM8TCgHvMZ1apzmUpjYJc'
 INSIGHT_URL = 'http://blockchain.coinawesome.com'
...
(function () {
	...
	/* other vars */
	coinjs.developer = 'AawayCoUtJSdQeM8TCgHvMZ1apzmUpjYJc';

	/* bit(coinb.in) api vars */
	coinjs.host = 'https://blockchain.coinawesome.com/api/'
	// coinjs.uid = '1';
	// coinjs.key = '12345678901234567890123456789012';


	/* start of address functions */
	var hexToString, toHex;
	...
	coinjs.addressBalance = function(address, callback){
		coinjs.ajax(coinjs.host+'addr/'+address+'/balance?noCache=1', callback, "GET");
	}
	...
	coinjs.transaction = function() {
		...
		r.adddata = function(data){
			var r = false;
			if(((data.match(/^[a-f0-9]+$/gi)) && data.length<512) && (data.length%2)==0) {
		...
		r.listUnspent = function(address, callback) {
			coinjs.ajax(coinjs.host+'addr/'+address+'/utxo?noCache=1', callback, "GET");
		}
		...
		r.addUnspent = function(address, callback){
			...
			this.listUnspent(address, function(data){
				...
				console.log('unspents',data)

				data.map(function(unspent) {
					self.addinput(unspent.txid, unspent.vout, unspent.scriptPubKey)
		...
		r.serialize = function(){
			...
			// CoinAwesome PoS change
			var time = Math.round(Date.now() / 1000)
			buffer = buffer.concat(coinjs.numToBytes(parseInt(time),4));
	...
	// url, callback, method, data
	coinjs.ajax = function(u, f, m, a){

		if(m==='POST') {
			console.log('POSTing tx...', a)
			$.post(u, a, f, 'json')
			// $.post('https://blockchain.coinawesome.com/api/tx/send', 
			// 	JSON.stringify({'rawtx': ''}), 
			// 	function(e, r) {console.log(e,r)}, 'json')
		} else {
		    $.getJSON(u, f)
		}
